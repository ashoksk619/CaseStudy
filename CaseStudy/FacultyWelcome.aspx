<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty.Master" AutoEventWireup="true" CodeBehind="FacultyWelcome.aspx.cs" Inherits="CaseStudy.FacultyWelcome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
		<marquee style="background-color:black; color:white;direction:ltr;height:25px;" scrollamount="12"><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></marquee>
